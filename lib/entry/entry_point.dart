...
import 'package:freemusic/components/side_menu.dart';
import 'package:freemusic/pages/login_page.dart';
import 'package:freemusic/pages/welcome.dart';
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            child: ClipRRect(
              ...
              child: isLoggedIn ? HomePage( categories: [],events: []) : const LoginPage( categories: [],events: []),
            ),
          ),
          AnimatedPositioned(
